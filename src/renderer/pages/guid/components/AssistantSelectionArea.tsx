...
const AssistantSelectionArea: React.FC<AssistantSelectionAreaProps> = ({ isPresetAgent, selectedAgentInfo, customAgents, localeKey, onSelectAssistant, onSetInput, onFocusInput }) => {
